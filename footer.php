<footer class="footer">
    <div class="wrapper">
		<div class="footer__menu">
            ...
            <div class="menu__social menu__social_footer">
        ...
        <div class="benefits-box">
            <div class="benefits__column footer__column">
                ...
                <a class="footer__phone" href="tel:<?echo $phone;?>"><?php the_field('telefon_contacts', 39)?></a>
            </div>
            <div class="benefits__column">
                <p class="footer__address">г. Гродно улица <?php the_field('address_contacts', 39);?></p>
            </div>
        </div>
    </div>
</footer>
