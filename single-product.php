            ...
            <div class="cart__box">
                ...
                <div class="cart__box__sidebar">
                    ...
                    <div class="cart__content">
                        ...
                        <a href="?add-to-cart=<?php echo get_the_ID(); ?>" data-quantity="1" class="topweek__basket topweek__basket_bottom button product_type_simple add_to_cart_button ajax_add_to_cart" data-product_id="<?php echo get_the_ID(); ?>" data-product_sku="" aria-label="Добавить &quot;Бор&quot; в корзину">
